# backend/tests/integration/test_catalog_cart_api.py
import pytest
...
class TestCatalogAPI:
    ...
    async def test_get_products_list(
        ...
        """GET /catalog/products — возвращает список товаров."""
    ...
    async def test_get_product_by_slug(
        ...
        """GET /catalog/products/{slug} — возвращает товар с вариантами."""
    ...
    async def test_get_product_not_found(self, client: AsyncClient):
        """GET /catalog/products/{slug} — 404 для несуществующего товара."""
    ...
    async def test_category_tree(self, client: AsyncClient, test_product):
        """GET /catalog/categories/tree — возвращает дерево категорий."""
...
class TestCartAPI:
    ...
    async def test_add_and_get_cart(
        ...
        """POST /cart/items + GET /cart — полный цикл добавления."""
    ...
    async def test_add_nonexistent_variant(
        ...
        """POST /cart/items — 404 для несуществующего варианта."""
        csrf_resp = await client.get("/api/v1/auth/csrf")
        csrf_token = csrf_resp.cookies.get("csrf_token")
