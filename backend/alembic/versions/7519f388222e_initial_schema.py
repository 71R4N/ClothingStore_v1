...
Revision ID: 7519f388222e
Revises: 
Create Date: 2026-06-07 19:30:49.671499
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['order_item_id'], ['order_items.id'], name=op.f('returns_order_item_id_fkey'), ondelete='CASCADE'),
    ...
    op.create_index('ix_returns_order_item_status', 'returns', ['order_item_id', 'status'], unique=False)
    ...
    op.create_index(op.f('returns_order_item_id_idx'), 'returns', ['order_item_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('returns_order_item_id_idx'), table_name='returns')
    op.drop_index(op.f('returns_order_id_idx'), table_name='returns')
    op.drop_index('ix_returns_order_status', table_name='returns')
    op.drop_index('ix_returns_order_item_status', table_name='returns')
